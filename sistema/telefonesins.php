...
if(isset($_POST['guarda'])) {
    ...
    $a_telefone = trim($_POST['telefone']);

    $a_ddd = trim($_POST['ddd']);
    ...
    $obj1 = new TelefonesVO();

    $obj1->set_telefone($a_telefone);

    $obj1->set_ddd($a_ddd);

    $obj1->set_stt(1);

    $obj1->set_principal($a_principal);
    ...
    $cIns = new Controller("telefones", "insert", $obj1);
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="clientes.php">Telefones</a></li>
                            ...
                            <form id="mainForm" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" class="form-horizontal">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-sm-2 control-label" for="tagNome">Telefone</label>

                                        <div class="col-sm-10">

                                            <input type="text" class="form-control" name="telefone" id="telefone" placeholder="Informe o telefone" maxlength="15" value="<?php echo $a_telefone;?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-sm-2 control-label" for="tagNome">DDD</label>
                                        <div class="col-sm-10">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $( "#mainForm" ).validate( {
                ...
                messages: {
                    nome: {
                        required: "Por favor, inform o telefone"
                    },
                    email: {
                        required: "Por favor, informe um DDD"
                    },
                },
                errorElement: "em",
